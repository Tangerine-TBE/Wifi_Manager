...
import com.example.module_base.utils.Rx.*
import com.example.module_base.utils.Rx.rxfeature.tool.RxBarCode
import com.example.module_base.utils.Rx.rxfeature.tool.RxQRCode
import com.example.module_base.utils.Rx.ticker.RxTickerUtils
    ...
    private fun initEvent() {
        ...
        iv_create_qr_code.setOnClickListener {
            ...
            if (RxDataTool.isNullString(str)) {
                ToastUtil.showToast("二维码文字内容不能为空！")
            } else {
