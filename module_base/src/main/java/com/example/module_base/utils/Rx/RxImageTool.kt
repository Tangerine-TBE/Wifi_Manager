...
import com.example.module_base.utils.Rx.RxFileTool.Companion.closeIO
import com.example.module_base.utils.Rx.RxFileTool.Companion.createOrExistsFile
import com.example.module_base.utils.Rx.RxFileTool.Companion.getFileByPath
import java.io.*
...
object RxImageTool {
    ...
    fun dp2px(dpValue: Float): Int {
        return dp2px(BaseApplication.mContext, dpValue)
    }
    ...
    fun px2dp(pxValue: Float): Int {
        return px2dp(BaseApplication.mContext, pxValue)
    }
    ...
    fun sp2px(spValue: Float): Int {
        val fontScale = BaseApplication.mContext.resources.displayMetrics.scaledDensity
    ...
    fun getBitmap(resId: Int): Bitmap? {
        val `is` = BaseApplication.mContext.resources.openRawResource(resId)
