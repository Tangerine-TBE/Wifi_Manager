package com.example.module_base.utils.Rx.ticker
...
import com.example.module_base.utils.Rx.RxActivityTool
import com.example.module_base.utils.Rx.RxDataTool.Companion.isNullString
import com.example.module_base.utils.Rx.RxImageTool.dp2px
import com.example.module_base.utils.Rx.RxKeyboardTool.hideSoftInput
...
class RxTitle : FrameLayout {
    ...
    private fun initView(context: Context, attrs: AttributeSet?) {
        ...
        try {
            ...
            //标题颜色
            mTitleColor = a.getColor(R.styleable.RxTitle_titleColorRx, resources.getColor(R.color.White))
