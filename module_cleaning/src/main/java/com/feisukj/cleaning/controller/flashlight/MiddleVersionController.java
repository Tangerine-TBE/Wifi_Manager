...
public class MiddleVersionController extends CompatController {
    ...
    private void startDevice() {
        ...
        try {
            ...
            Log.e(TAG, "The System will reject the cameraVideo permission and not open cameraVideo");
        } catch (Throwable throwable) {
            Log.e(TAG, "Couldn't open the cameraVideo use the cameraId by the CameraManager");
        }
    }
    ...
    private final CameraDevice.StateCallback mCameraListener = new CameraDevice.StateCallback() {
        ...
        public void onError(CameraDevice camera, int error) {
            Log.e(TAG, "Camera error: cameraVideo = " + camera + " error=" + error);
