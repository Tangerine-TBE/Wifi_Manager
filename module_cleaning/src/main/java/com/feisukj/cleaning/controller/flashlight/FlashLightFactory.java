...
public interface FlashLightFactory {
    ...
    /**
     * indicating that the cameraVideo device could not be opened due to a device
     * policy.
     ...
     * indicating that the cameraVideo service has encountered a fatal error.
     *
     * <p>The Android device may need to be shut down and restarted to restore
     * cameraVideo function, or there may be a persistent hardware problem.</p>
     *
    ...
    /**
     * An error code that can be reported by {@link #onError}
     * indicating that the cameraVideo device has encountered a fatal error.
     *
     * <p>The cameraVideo device needs to be re-opened to be used again.</p>
     */
