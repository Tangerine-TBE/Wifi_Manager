    ...
    class Builder internal constructor(private var text: CharSequence) {
        ...
        private fun setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(ImageSpan(BaseApplication.mContext, bitmap!!), start, end, flag)
                    bitmap = null
                    imageIsBitmap = false
                    ...
                    mBuilder.setSpan(ImageSpan(BaseApplication.mContext, uri!!), start, end, flag)
                    uri = null
                    imageIsUri = false
                } else {
                    mBuilder.setSpan(ImageSpan(BaseApplication.mContext, resourceId), start, end, flag)
                    resourceId = 0
